...
public class MyFaceDetectActivity extends Activity implements CvCameraViewListener2 {
    ...
    private ImageView imageViewFace;//人脸图
...
//               Imgproc.rectangle(mRgba, tl, br, FACE_RECT_COLOR, 3);
        ...
        if (null != maxRect) {
            ...
            Mat targetMat = new Mat(mRgba, maxRect);
            if(targetMat.cols()>0 && targetMat.rows()>0){
